...
def simulator_process(control_file: str, log_file: str):
    ...
    scenarios = [
        ...
        ("tap_shift", "placeholder", {"key": "shift"}),
        ("tap_ctrl", "tap_ctrl_test", {"key": "ctrl"}),
        ("tap_alt", "tap_alt_test", {"key": "alt"}),
        ("tap_win", "tap_win_test", {"key": "win"}),
        ...
        ("rapid_taps", "rapid_taps_test", {"keys": ["a", "b", "c", "d", "e"], "delay": 0.05}),
...
def main():
    ...
    print(f"filter_self status: {'disabled' if disable_filter else 'enabled'}")
    print("=" * 80)
