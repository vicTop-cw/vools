...
def _generate_date_range(start_date: datetime, end_date: datetime, freq: str) -> List[datetime]:
...
def _generate_date_range_by_periods(start_date: datetime, periods: int, freq: str) -> List[datetime]:
...
def _generate_date_range_by_end_periods(end_date: datetime, periods: int, freq: str) -> List[datetime]:
