...
Function BSTR2S cdecl (ByVal BS As Const BSTR, ByVal CodePage As UINT = CP_ACP) As String
    ...
    Return S
End Function
Function S2BSTR cdecl (S As Const String, ByVal CodePage As UINT = CP_ACP) As BSTR 'the caller is responsible for freeing the returned BSTR per SysFreeString
